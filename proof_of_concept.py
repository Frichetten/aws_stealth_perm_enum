...
services = {  
        'application-autoscaling:application-autoscaling:404': [  'AnyScaleFrontendService.DeleteScalingPolicy',
   ...
   'appstream:appstream2:404': [  'PhotonAdminProxyService.CreateDirectoryConfig',
   ...
   'athena:athena:404': [  'AmazonAthena.ListDataCatalogs',
                           'AmazonAthena.ListWorkGroups'],
   'autoscaling-plans:autoscaling-plans:404': [  'AnyScaleScalingPlannerFrontendService.CreateScalingPlan',
   ...
   'aws-marketplace:entitlement.marketplace:404': [  'AWSMPEntitlementService.GetEntitlements'],
   'aws-marketplace:metering.marketplace:500': [  'AWSMPMeteringService.BatchMeterUsage',
                                                  'AWSMPMeteringService.MeterUsage',
                                                  'AWSMPMeteringService.RegisterUsage',
                                                  'AWSMPMeteringService.ResolveCustomer'],
   'cloudhsm:cloudhsm:404': [  'CloudHsmFrontendService.AddTagsToResource',
   ...
   'cloudhsm:cloudhsmv2:500': [  'BaldrApiService.DescribeBackups',
                                 'BaldrApiService.DescribeClusters'],
   'codecommit:codecommit:404': [  'CodeCommit_20150413.CreateApprovalRuleTemplate',
   ...
   'codepipeline:codepipeline:404': [  'CodePipeline_20150709.AcknowledgeJob',
   ...
   'codestar:codestar:404': [  'CodeStar_20170419.DescribeUserProfile',
                               'CodeStar_20170419.ListProjects',
                               'CodeStar_20170419.ListUserProfiles'],
   'comprehend:comprehend:500': [  'Comprehend_20171127.BatchDetectDominantLanguage',
   ...
   'cur:cur:404': ['AWSOrigamiServiceGatewayService.DescribeReportDefinitions'],
   'datapipeline:datapipeline:404': [  'DataPipeline.ActivatePipeline',
   ...
   'dax:dax:404': [  'AmazonDAXV3.CreateCluster',
   ...
   'directconnect:directconnect:404': [  'OvertureService.AcceptDirectConnectGatewayAssociationProposal',
   ...
   'discovery:discovery:500': [  'AWSPoseidonService_V2015_11_01.AssociateConfigurationItemsToApplication',
   ...
   'forecast:forecast:404': [  'AmazonForecast.CreateDataset',
   ...
   'forecast:forecastquery:404': ['AmazonForecastRuntime.QueryForecast'],
   'gamelift:gamelift:404': [  'GameLift.AcceptMatch',
   ...
   'health:health:403': [  'AWSHealth_20160804.DescribeAffectedAccountsForOrganization',
   ...
   'identitystore:identitystore:500': [  'AWSIdentityStore.DescribeGroup',
                                         'AWSIdentityStore.DescribeUser',
                                         'AWSIdentityStore.ListGroups',
                                         'AWSIdentityStore.ListUsers'],
   'kinesis:kinesis:404': ['Kinesis_20131202.ListStreams'],
   'kinesisanalytics:kinesisanalytics:404': [  'KinesisAnalytics_20150814.ListApplications',
                                               'KinesisAnalytics_20180523.ListApplications'],
   'macie:macie:404': [  'MacieService.AssociateMemberAccount',
   ...
   'mediastore:mediastore:500': ['MediaStore_20170901.ListContainers'],
   'mgh:migrationhub-config:403': [  'AWSMigrationHubMultiAccountService.CreateHomeRegionControl',
                                     'AWSMigrationHubMultiAccountService.DescribeHomeRegionControls',
                                     'AWSMigrationHubMultiAccountService.GetHomeRegion'],
   'mturk-requester:mturk-requester:500': [  'MTurkRequesterServiceV20170117.AcceptQualificationRequest',
   ...
   'opsworks-cm:opsworks-cm:404': [  'OpsWorksCM_V2016_11_01.DescribeAccountAttributes'],
   'personalize:personalize:404': [  'AmazonPersonalize.ListDatasetGroups',
                                     'AmazonPersonalize.ListRecipes',
                                     'AmazonPersonalize.ListSchemas'],
   'redshift-data:redshift-data:404': [  'RedshiftData.CancelStatement',
                                         'RedshiftData.DescribeStatement',
                                         'RedshiftData.GetStatementResult',
                                         'RedshiftData.ListStatements'],
   'route53domains:route53domains:403': [  'Route53Domains_v20140515.AcceptDomainTransferFromAnotherAwsAccount',
   ...
   'route53resolver:route53resolver:404': [  'Route53Resolver.AssociateResolverQueryLogConfig',
   ...
   'sagemaker:api.sagemaker:404': [  'SageMaker.GetSearchSuggestions',
                                     ...
                                     'SageMaker.Search'],
   'secretsmanager:secretsmanager:404': [  'secretsmanager.CancelRotateSecret',
   ...
   'shield:shield:404': [  'AWSShield_20160616.AssociateDRTLogBucket',
   ...
   'sms:sms:404': [  'AWSServerMigrationService_V2016_10_24.CreateApp',
   ...
   'snowball:snowball:404': [  'AWSIESnowballJobManagementService.CancelCluster',
   ...
   'support:support:403': [  'AWSSupport_20130415.AddAttachmentsToSet',
   ...
   'tagging:tagging:500': [  'ResourceGroupsTaggingAPI_20170126.DescribeReportCreation',
   ...
   'textract:textract:404': [  'Textract.AnalyzeDocument',
                               'Textract.DetectDocumentText',
                               'Textract.GetDocumentAnalysis',
                               'Textract.GetDocumentTextDetection',
                               'Textract.StartDocumentAnalysis',
                               'Textract.StartDocumentTextDetection'],
   'translate:translate:500': [  'AWSShineFrontendService_20170701.DeleteTerminology',
   ...
   'workmail:workmail:403': [  'WorkMailService.AssociateDelegateToResource',
...
def make_call(signing_name, service_target, action, response_code):
    method = 'POST'
    ...
    # If the status codes are the same
    if r.status_code == int(response_code):
        # Need to account for when the status codes are the same but the hashes were
        # different. We do this based on keywords in the response body
        if r.status_code == 403 and "<Message>User: arn" in r.text:
            # You do not have permissions to call %s:%s
            None
        else:
            print("You have permissions to call %s:%s" % (service,action))

    #print("%i: %s:%s" % (r.status_code, service, action))
...
for item in services:
    for action in services[item]:
        items = item.split(":")
        make_call(items[0], items[1], action, items[2])
