...
services = {  
   ...
   'codestar:codestar': [  'CodeStar_20170419.DescribeUserProfile',
                           'CodeStar_20170419.ListProjects',
                           'CodeStar_20170419.ListUserProfiles'],
   'comprehend:comprehend': [  'Comprehend_20171127.BatchDetectDominantLanguage',
   ...
   'cur:cur': ['AWSOrigamiServiceGatewayService.DescribeReportDefinitions'],
   'datapipeline:datapipeline': [  'DataPipeline.ActivatePipeline',
   ...
   'dax:dax': [  'AmazonDAXV3.CreateCluster',
   ...
   'directconnect:directconnect': [  'OvertureService.AcceptDirectConnectGatewayAssociationProposal',
   ...
   'discovery:discovery': [  'AWSPoseidonService_V2015_11_01.AssociateConfigurationItemsToApplication',
   ...
   'forecast:forecast': [  'AmazonForecast.CreateDataset',
   ...
   'gamelift:gamelift': [  'GameLift.AcceptMatch',
   ...
   'health:health': [  'AWSHealth_20160804.DescribeAffectedAccountsForOrganization',
   ...
   'identitystore:identitystore': [  'AWSIdentityStore.DescribeGroup',
                                     'AWSIdentityStore.DescribeUser',
                                     'AWSIdentityStore.ListGroups',
                                     'AWSIdentityStore.ListUsers'],
   'kinesis:kinesis': ['Kinesis_20131202.ListStreams'],
   'kinesisanalytics:kinesisanalytics': [  'KinesisAnalytics_20150814.ListApplications',
                                           'KinesisAnalytics_20180523.ListApplications'],
   'macie:macie': [  'MacieService.AssociateMemberAccount',
   ...
   'mediastore:mediastore': ['MediaStore_20170901.ListContainers'],
   'mgh:migrationhub-config': [  'AWSMigrationHubMultiAccountService.CreateHomeRegionControl',
                                 'AWSMigrationHubMultiAccountService.DescribeHomeRegionControls',
                                 'AWSMigrationHubMultiAccountService.GetHomeRegion'],
   'mturk-requester:mturk-requester': [  'MTurkRequesterServiceV20170117.AcceptQualificationRequest',
   ...
   'opsworks-cm:opsworks-cm': [  'OpsWorksCM_V2016_11_01.DescribeAccountAttributes'],
   'personalize:personalize': [  'AmazonPersonalize.ListDatasetGroups',
                                 'AmazonPersonalize.ListRecipes',
                                 'AmazonPersonalize.ListSchemas'],
   'redshift-data:redshift-data': [  'RedshiftData.CancelStatement',
                                     'RedshiftData.DescribeStatement',
                                     'RedshiftData.GetStatementResult',
                                     'RedshiftData.ListStatements'],
   'route53domains:route53domains': [  'Route53Domains_v20140515.AcceptDomainTransferFromAnotherAwsAccount',
   ...
   'route53resolver:route53resolver': [  'Route53Resolver.AssociateResolverQueryLogConfig',
   ...
   'sagemaker:api.sagemaker': [  'SageMaker.GetSearchSuggestions',
                                 ...
                                 'SageMaker.Search'],
   'secretsmanager:secretsmanager': [  'secretsmanager.CancelRotateSecret',
   ...
   'shield:shield': [  'AWSShield_20160616.AssociateDRTLogBucket',
   ...
   'sms:sms': [  'AWSServerMigrationService_V2016_10_24.CreateApp',
   ...
   'snowball:snowball': [  'AWSIESnowballJobManagementService.CancelCluster',
   ...
   'support:support': [  'AWSSupport_20130415.AddAttachmentsToSet',
   ...
   'tagging:tagging': [  'ResourceGroupsTaggingAPI_20170126.DescribeReportCreation',
   ...
   'textract:textract': [  'Textract.AnalyzeDocument',
                           'Textract.DetectDocumentText',
                           'Textract.GetDocumentAnalysis',
                           'Textract.GetDocumentTextDetection',
                           'Textract.StartDocumentAnalysis',
                           'Textract.StartDocumentTextDetection'],
   'translate:translate': [  'AWSShineFrontendService_20170701.DeleteTerminology',
   ...
   'workmail:workmail': [  'WorkMailService.AssociateDelegateToResource',
